...
export interface Transfer128TestsContractInterface extends Interface {
...
export interface Transfer128TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): Transfer128TestsContract;
  waitForDeployment(): Promise<this>;

  interface: Transfer128TestsContractInterface;
