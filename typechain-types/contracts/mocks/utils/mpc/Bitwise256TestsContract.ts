...
export interface Bitwise256TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "andTest"
      | "getAndResult"
...
export interface Bitwise256TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): Bitwise256TestsContract;
  waitForDeployment(): Promise<this>;

  interface: Bitwise256TestsContractInterface;
