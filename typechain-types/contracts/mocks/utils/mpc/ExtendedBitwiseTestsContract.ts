...
export interface ExtendedBitwiseTestsContractInterface extends Interface {
  getFunction(
    nameOrSignature: "andTest" | "numbers" | "orTest" | "xorTest"
  ): FunctionFragment;
...
export interface ExtendedBitwiseTestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): ExtendedBitwiseTestsContract;
  waitForDeployment(): Promise<this>;

  interface: ExtendedBitwiseTestsContractInterface;
