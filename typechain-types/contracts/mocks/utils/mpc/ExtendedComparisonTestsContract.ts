...
export interface ExtendedComparisonTestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "boolResults"
      | "eqTest"
...
export interface ExtendedComparisonTestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): ExtendedComparisonTestsContract;
  waitForDeployment(): Promise<this>;

  interface: ExtendedComparisonTestsContractInterface;
