...
export interface Arithmetic256TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addTest"
      | "checkedAddTest"
...
export interface Arithmetic256TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): Arithmetic256TestsContract;
  waitForDeployment(): Promise<this>;

  interface: Arithmetic256TestsContractInterface;
