...
export interface Mux128TestsContractInterface extends Interface {
...
export interface Mux128TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): Mux128TestsContract;
  waitForDeployment(): Promise<this>;

  interface: Mux128TestsContractInterface;
