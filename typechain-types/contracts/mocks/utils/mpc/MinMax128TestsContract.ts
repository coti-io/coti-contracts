...
export interface MinMax128TestsContractInterface extends Interface {
  getFunction(
...
export interface MinMax128TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): MinMax128TestsContract;
  waitForDeployment(): Promise<this>;

  interface: MinMax128TestsContractInterface;
