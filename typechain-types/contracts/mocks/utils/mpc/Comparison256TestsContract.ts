...
export interface Comparison256TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eqTest"
      | "geTest"
...
export interface Comparison256TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): Comparison256TestsContract;
  waitForDeployment(): Promise<this>;

  interface: Comparison256TestsContractInterface;
