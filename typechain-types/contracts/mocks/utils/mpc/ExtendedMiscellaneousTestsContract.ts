...
export interface ExtendedMiscellaneousTestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "a"
      | "allowance"
...
export interface ExtendedMiscellaneousTestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): ExtendedMiscellaneousTestsContract;
  waitForDeployment(): Promise<this>;

  interface: ExtendedMiscellaneousTestsContractInterface;
