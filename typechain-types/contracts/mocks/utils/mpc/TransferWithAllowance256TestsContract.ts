...
export interface TransferWithAllowance256TestsContractInterface
  extends Interface {
  getFunction(
...
export interface TransferWithAllowance256TestsContract extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): TransferWithAllowance256TestsContract;
  waitForDeployment(): Promise<this>;

  interface: TransferWithAllowance256TestsContractInterface;
