...
export interface CheckedArithmetic256WithOverflowBitTestsContractInterface
  extends Interface {
  getFunction(
    nameOrSignature:
...
export interface CheckedArithmetic256WithOverflowBitTestsContract
  ...
  interface: CheckedArithmetic256WithOverflowBitTestsContractInterface;
