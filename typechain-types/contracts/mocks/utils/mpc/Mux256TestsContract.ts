...
export interface Mux256TestsContractInterface extends Interface {
  getFunction(nameOrSignature: "getMuxResult" | "muxTest"): FunctionFragment;
...
export interface Mux256TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): Mux256TestsContract;
  waitForDeployment(): Promise<this>;

  interface: Mux256TestsContractInterface;
