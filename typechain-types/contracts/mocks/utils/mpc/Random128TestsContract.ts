...
export interface Random128TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getRandom"
      | "getRandomBounded"
...
export interface Random128TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): Random128TestsContract;
  waitForDeployment(): Promise<this>;

  interface: Random128TestsContractInterface;
