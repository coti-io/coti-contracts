...
export interface ExamplePrivateERC20MockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ExamplePrivateERC20Mock extends BaseContract {
  connect(runner?: ContractRunner | null): ExamplePrivateERC20Mock;
  waitForDeployment(): Promise<this>;

  interface: ExamplePrivateERC20MockInterface;
