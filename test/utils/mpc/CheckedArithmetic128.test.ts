...
describe("Checked Arithmetic 128-bit with Overflow Bit", function () {
  buildTest("CheckedArithmetic128WithOverflowBitTestsContract", "checkedAddWithOverflowBitTest", "getAddResult", params, a + b)
  buildTest("CheckedArithmetic128WithOverflowBitTestsContract", "checkedSubWithOverflowBitTest", "getSubResult", params, a - b)
  buildTest("CheckedArithmetic128WithOverflowBitTestsContract", "checkedMulWithOverflowBitTest", "getMulResult", params, a * b)
})
